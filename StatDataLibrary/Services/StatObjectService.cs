...
namespace StatDataLibrary.Services
{
    ...
    public class StatObjectService
    {
        ...
        public static List<TreasureTable> GenerateTreasureTable(IDictionary<string, List<StatDataEntry>> entriesByType, IDictionary<string, int> quantities, string modName)
        {
            ...
            {
                tables.Add(TreasureTable.Create($"ALL_{type.ToUpper()}S", entries, modName, quantities[type]));
            }
